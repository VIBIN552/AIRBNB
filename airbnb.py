...
def datafr():
    df =pd.read_csv(r"C:\Users\vibin\OneDrive\Desktop\AIRBNB\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\Users\vibin\OneDrive\Desktop\AIRBNB\download.jpeg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv(r"C:\Users\vibin\OneDrive\Desktop\AIRBNB\Airbnb.csv")
            return df_a
